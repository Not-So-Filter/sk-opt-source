...
V_int_routine			ds.w 1
V_int_counter			ds.b 1
			ds.b 1				; unused
...
Nem_decomp_queue		ds.b 6*6		; 6 bytes per entry, first longword is source location and next word is VRAM destination
...
Kos_module_queue		ds.w 6*16		; 6 bytes per entry, first longword is source location and next word is VRAM destination
...
Kos_module_size =	Kos_module_queue_End-Kos_decomp_stored_registers
...
Checksum_string :=		*		; S3 uses a different address
				ds.w 1			; set to Ref_Checksum_String once the checksum routine has run
RAM_end := *
